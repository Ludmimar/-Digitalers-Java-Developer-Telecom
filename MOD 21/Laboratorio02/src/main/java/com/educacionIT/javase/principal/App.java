...
public class App {
	public static void main(String[] args) {
		...
		System.out.println("Ingreso de Datos de Personas Laboratorio 2");
		...
		for (int i = 0; i < personas.length; i++) {
			...
			// Persona personaAuxiliar = new Persona(nombre, apellido, new Documento(tipoDocumento, numeroDocumento), edad);
