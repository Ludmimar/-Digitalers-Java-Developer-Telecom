...
import com.educacionit.desafio02.entidades.Cliente;
...
import com.educacionit.desafio02.enumerados.TipoDocumento;
		...
		try {
			...
			while (true) {
				try {
					...
					tipoDocumento = TipoDocumento.valueOf(teclado.next());
					break;
				} catch (Exception e) {
					System.out.println(
